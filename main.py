...
silver = silver_temp.subsample(3)
...
fairgrounds_temp = PhotoImage(file = r"Images\fairgrounds.png.png")
...
# Cards
silver_card = Victory("Silver", -5, 0)
...
counter_1.place(x=650, y = 0)
counter_2.place(x=1485, y = 0)
...
# Button_silver.place(x=20, y=150)
...
Button_castle1.place(x=20, y=150)
Button_fairgrounds.place(x=170, y=150)
Button_distant_lands.place(x=320, y=150)
Button_gardens.place(x=470, y=150)
Button_cemetery.place(x=620, y=150)
Button_tunnel.place(x=770, y=150)
Button_farmland.place(x=20, y=150)
Button_dame_josephine.place(x=170, y=150)
Button_harem.place(x=320, y=370)
Button_island.place(x=470, y=370)
Button_nobles.place(x=620, y=370)
Button_duchy.place(x=770, y=370)
Button_duke.place(x=20, y=370)
Button_province.place(x=170, y=590)
