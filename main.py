...
Button_mill.place(x=320, y=150)
Button_feodum.place(x=470, y=150)
Button_silk_road.place(x=620, y=150)
Button_cemetery.place(x=770, y=150)
Button_harem.place(x=20, y=370)
Button_island.place(x=170, y=370)
Button_nobles.place(x=320, y=370)
Button_duchy.place(x=470, y=370)
Button_duke.place(x=620, y=370)
Button_province.place(x=20, y=590)
Button_colony.place(x=20, y=810)
# P2
